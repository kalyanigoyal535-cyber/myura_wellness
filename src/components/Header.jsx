...
export default function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setBgColor(window.scrollY > 20 ? 'white' : 'transparent')
    }
  ...
  return (
    <motion.header
      ...
      {/* Top Banner */}
      <div
        className="text-center text-xs py-1 px-3 bg-emerald-50 text-emerald-800 flex items-center justify-center gap-2 shadow-sm overflow-hidden"
        data-aos="fade-down">
        <motion.svg
        ...
        <motion.div
          ...
          data-aos="fade-left">
          <motion.svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="w-5 h-5">
      ...
      "
        data-aos="fade-down">
        {/* Logo */}
        <Link to="/" className="flex items-center justify-center overflow-visible" data-aos="zoom-in">
          <img
            ...
            className="
              ...
              lg:w-[260px] lg:h-[85px]
              xl:w-[260px] xl:h-[90px]
        ...
        {/* Desktop Nav */}
        <nav className="hidden md:flex gap-5 text-gray-800 text-md justify-center w-full" data-aos="fade-left">
          {navItems.map((item) => (
            <NavLink
              key={item.name}
              to={item.path}
        ...
        <div className="flex items-center gap-2" data-aos="fade-right">
          ...
          <button className="md:hidden p-2 rounded-full hover:bg-emerald-50" onClick={() => setIsOpen(!isOpen)} data-aos="fade-right">
